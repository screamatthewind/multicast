...
#define MAX_URL_PARAM_SIZE 128

int parse_url_parms(char *data, struct yuarel_param *params);
...
private:
	...
	union {
		 // according to "The GNU C Library Reference Manual"
	  struct dirent d;
