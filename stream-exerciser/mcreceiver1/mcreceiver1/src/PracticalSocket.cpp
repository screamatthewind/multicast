...
void UDPSocket::disconnect() throw(SocketException) {
	...
	void UDPSocket::joinGroup(const string &multicastGroup, const string &iifAddress) throw(SocketException) {
		...
		if (iifAddress.empty())
			...
			multicastRequest.imr_interface.s_addr = inet_addr(iifAddress.c_str());
